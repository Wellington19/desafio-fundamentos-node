...
Aplicação backend Node.js com TypeScript, utilizando o conceito de models, repositories e services para armazenar transações financeiras de entrada e saída, que permite o cadastro e a listagem dessas transações seguindo os requisitos propostos logo abaixo pelo desafio 5 do bootcamp GoStack da Rocketseat.
